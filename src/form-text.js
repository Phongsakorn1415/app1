        ...
        <div className="mt-4 mx-auto p-3 rounded" style={{width:'400px', background:'#cee'}}>
            <form>
                <div className="form-group mb-2">
                    <label htmlFor="login" className="form-label">รหัสผ่าน</label>
                    <input type="text" id="login" name="login" maxLength="20" className="form-control form-control-sm"></input>
                </div>
                <div className="form-group mb-2">
                    <label htmlFor="pswd" className="form-label">รหัสผ่าน</label>
                ...
                <div className="form-group mb-2">
                    <label htmlFor="pswd2" className="form-label">ใส่รหัสผ่านซ้ำ</label>
